...
switch(tabCounter){
	case 0:
		...
		PlayerLoad_Password_Box.Password_Box.alarm[0]=25;
		tabCounter=1;
		break;
	case 1:
		//show_debug_message("Going to cONFIRM Box");
		PlayerLoad_Password_Box.Password_Box.pass_typing = false;
		PlayerLoad_Password_Box.Password_Box.pass_blink = false;
		PlayerLoad_Password_Box.Password_Box.alarm[0] = -1;
		keyboard_string = "";
